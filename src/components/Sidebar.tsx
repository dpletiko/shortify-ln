        ...
        <div className="w-full flex overflow-y-auto py-4 mb-3 rounded">
          <ul className="space-y-2 w-full">
            ...
            <li>
              <button 
                onClick={() => signOut()}
                className="flex w-full py-2 text-base font-normal hover:font-medium text-gray-900 dark:text-white rounded-lg transition-colors duration-250 drop-shadow-md hover:drop-shadow-xl hover:text-[#9333EA]"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" className="w-6 h-6 stroke-gray-900 dark:stroke-white">
