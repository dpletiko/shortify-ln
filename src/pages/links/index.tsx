    ...
    <tr className="border-b">
      ...
      <td className="px-4 py-2 whitespace-nowrap text-sm flex">
        <Link 
          ...
          title="Expand row"
        >
          <a className="rounded-full btn-outline px-5 py-2 outline-none text-gray-900 dark:text-white flex flex-row items-center text-xs mr-2">
        ...
        <button 
          ...
          className="rounded-full btn-outline outline-none p-2 text-base font-normal text-gray-900 dark:text-white transition-colors duration-250 drop-shadow-md hover:drop-shadow-xl stroke-gray-900 dark:stroke-white hover:stroke-[#9333EA] dark:hover:stroke-[#9333EA]"
        >
